...
args = ListOfArgs([
    ...
    Arg('EPI_COEFF', help="Coefficient of Epigenetic Mark Spreading Model (experimental).", type=float, default='0.0', val='0.0'),
    Arg('N_EPI_STATES', help="Number of epigenetic states in the Potts model (by default 3: -1,0,1)", type=int, default='3', val='3'),
    Arg('P_SPIN', help="Probability that it would be proposed a node state move, instead of a LEF move.", type=float, default='0.5', val='0.5'),
    ...
    Arg('LE_FF_STRENGTH', help="Interaction Strength of loop forces.", type=float, default='60000.0', val='60000.0'),
    Arg('DO_COMPARTMENTS', help="True to enable block-copolymer force in 3D.", type=bool, default='False', val='False'),
